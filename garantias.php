...
<body class="page-garantias">
    ...
    <div class="container">
        ...
        <!-- AÑADIDO: 'content-box' para que tenga fondo blanco y sombra -->
        <main class="content-box">
            <p style="margin-bottom:20px; color:#555;">
                Rellena los datos de la incidencia. Generaremos un PDF con las imágenes adjuntas listo para enviar.
            </p>
            ...
            <form id="warrantyForm" class="warranty-form">
                ...
                <div class="form-group">
                    <label for="invoice">Nº Albarán / Factura:</label>
                    <input type="text" id="invoice" class="form-input" required placeholder="Ej: FA-2024-001">
                </div>

                <div class="form-group">
                    <label for="reason">Descripción de la incidencia:</label>
                    <textarea id="reason" rows="5" class="form-textarea" required placeholder="Describe brevemente qué le ocurre al producto..."></textarea>
                </div>

                <div class="upload-area">
                    <h4 style="margin-top:0;">📸 Evidencias Fotográficas</h4>
    ...
    <script>
        document.getElementById('warrantyForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                doc.setFontSize(16);
                doc.text("HOJA DE RECLAMACIÓN", 195, 20, { align: 'right' });
                doc.setFontSize(10);
                ...
                doc.text(`Factura/Albarán: ${invoice}`, 15, 67);
                ...
                alert("Error al generar PDF. Intenta con imágenes más pequeñas.");
                console.error(error);
            }
